...
public class GPHandlerAdapter {
    ...
    public GPModelAndView handle(HttpServletRequest req,HttpServletResponse resp , Object handler) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        // 只有当用户传过来的ModelAndView为空的额时候，才会新建一个默认的
        ...
        for(Entry<String, String[]> param : reqParameterMap.entrySet()) {
